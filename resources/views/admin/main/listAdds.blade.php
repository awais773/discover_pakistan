...
<div class="container">
    <div class="container-fluid">
        ...
        @endif
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Adds</h1>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <!--<div class="card-header py-3">-->
            <!--    <a class="btn btn-primary" href="{{ url('/addsCreate') }}">Add Adds</a>-->
            <!--</div>-->
            <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Name: activate to sort column ascending"
                                                style="width: 131.172px;">Mobile Image</th> 
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Name: activate to sort column ascending"
                                                style="width: 131.172px;">Catgory</th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Name: activate to sort column ascending"
                                                style="width: 131.172px;">Link</th>    
                                    ...
                                    <tbody>
                                        @foreach ($Withdraw as $user)
                                            <tr class="even">
                                                <td>{{ $user->id }}</td>
                                                <td><img width="100" style="margin-bottom:9px" height="80"
                                                        src="{{ asset('/' . $user->image) }}" alt=""
                                                        srcset=""></td>
                                                <td><img width="100" style="margin-bottom:9px" height="80"
                                                            src="{{ asset('/' . $user->mobile_image) }}" alt=""
                                                            srcset=""></td>       
                                                <td>{{ $user->category }}</td>
                                                <td>{{ $user->links }}</td>
         ...
         <h1 class="h3 mb-2 text-gray-800">Discover Shows</h1>

        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a class="btn btn-primary" href="{{ url('/addsCreate') }}">Add Discover Shows</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
