    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a class="btn btn-primary" href="{{ url('/home/create') }}">Add Slider</a>
            </div>
            <div class="card-body">
                                        ...
                                        @foreach ($Withdraw as $user)
                                            <tr class="even">
                                                ...
                                                <td><img width="100" style="margin-bottom:9px" height="80"
                                                        src="{{ asset('/' . $user->slider_image) }}" alt=""
                                                        srcset=""></td>
                                                        <td>{{ $user->link }}</td>
...
<br>
        <h1 class="h3 mb-2 text-gray-800">Notification Text</h1>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-body">
                <div class="table-responsive">
                                ...
                                <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Name: activate to sort column ascending"
                                                style="width: 131.172px;">Baner Text</th>
                                    ...
                                    <tbody>
                                            <tr class="even">
                                                ...
                                                <a class="btn btn-success" href="{{ url('/withdraws',$user->id) }}"> <i class="fas fa-edit"></i></a>
                                                    ...
                                                    <div style="  margin-left: 10px;">
                                                           <div style="  margin-right: 10px">    
                                                <a class="btn btn-success" href="{{ url('/banerTax',$baners->id) }}"> <i class="fas fa-edit"></i></a>
                                            </div>
                                                    </div>
                                                </td>
                                            </tr>
