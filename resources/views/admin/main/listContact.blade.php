...
<div class="container">
    <div class="container-fluid">
        ...
        @endif
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Adventure Request</h1>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            {{-- <div class="card-header py-3">
                <a class="btn btn-primary" href="{{ url('/JobCreate') }}">Add Job</a>
            </div> --}}
            <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Name: activate to sort column ascending"
                                                style="width: 131.172px;">Phone No</th>
                                                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Name: activate to sort column ascending"
                                                style="width: 131.172px;">Message</th>
                                            ...
                                            <tr class="even">
                                                ...
                                                <td>{{ $user->city }}</td>                                               
                                                    ...
                                                    <div style="  margin-right: 10px">
                                                        <a class="btn btn-success" href="{{ url('/Jobedit',$user->id) }}">Edit</a>
                                                    </div>
                                                    <div style="  margin-left: 10px;">
                                                        <form method="post" action="{{ url('/JobDestroy', $user->id) }}">
                                                            @method('delete')
                                                            @csrf
