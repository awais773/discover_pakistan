    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a class="btn btn-primary" href="{{ url('/CategoryCreate') }}">Add Category</a>
            </div>
            <div class="card-body">
                                        ...
                                        @foreach ($Withdraw as $user)
                                            <tr class="even">
                                                ...
                                                <td><img width="100" style="margin-bottom:9px" height="80"
                                                    src="{{ asset('/' . $user->icon) }}" alt=""
                                                    srcset=""></td>                                               
                                                     <td style="display: flex">
                                                    <div style="  margin-right: 10px">
                                                        <a class="btn btn-success" href="{{ url('/Categoryedit',$user->id) }}">Edit</a>
                                                    </div>
                                                    <div style="  margin-left: 10px;">
                                                        <form method="post" action="{{ url('/CategoryDestroy', $user->id) }}">
                                                            @method('delete')
                                                            @csrf
